...
function sumar() {
  try {
    ...
    var url = "/api/sumar?a=" + encodeURIComponent(vals.a) + "&b=" + encodeURIComponent(vals.b);
    fetch(url)
...
function restar() {
  try {
    var vals = obtenerValores();
    var url = "/api/restar?a=" + encodeURIComponent(vals.a) + "&b=" + encodeURIComponent(vals.b);
    fetch(url)
      .then(function (r) { return r.json(); })
      .then(function (data) { mostrarSalida(data); })
      .catch(function (e) { mostrarSalida("Error: " + e); });
